...
A listagem nao traz descricao, e o portao de relevancia do projeto depende
dela. Buscar a descricao de todas as vagas de nivel de entrada custaria umas
220 requisicoes por execucao; filtrando antes pelo que a listagem ja informa
-- titulo, data, modalidade e local -- sobram 46. Por isso existe o pre-filtro
daqui, e ele chama as MESMAS funcoes do pipeline, nao copias: o pipeline as
reaplica depois, entao isto e so economia de requisicao, nunca regra propria.

**A senioridade declarada pelo portal e ignorada de proposito.** Medido em
2026-09-11: de 741 vagas, 292 vinham como `Intern`, entre elas "Gerente de
Infraestrutura de TI - LATAM", "Auditor Pleno em Tecnologia e Seguranca" e
"Analista de Produtos de TI Pleno". Isso importa mais do que parece, porque
`filter_entry_level` respeita nivel declarado pela fonte e nem consulta o
titulo -- aceitar esse campo faria passar gerente e pleno. Aqui o campo fica
vazio e quem decide e o regex sobre o titulo.

Composicao medida: 395 das 741 vem do mesmo portal da Gupy que este projeto ja
raspa direto, e a deduplicacao por titulo+empresa colapsa essas. O que o portal
acrescenta de verdade e a curadoria manual dele, mais InfoJobs e Solides: das
43 vagas que sobraram no funil, 37 eram da curadoria manual.
...
PAGE_SIZE = 100
# Teto de seguranca. Hoje o acervo cabe em 8 paginas.
MAX_PAGINAS = 20

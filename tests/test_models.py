...
def test_to_row_preserva_as_secoes_da_vaga():
    """500 cortava requisitos e benefícios, que vêm depois do 1º parágrafo."""
    job = Job(source="t", external_id="1", title="Dev",
              description="a" * 900 + " Requisitos e qualificações Java")
    assert "Requisitos" in job.to_row()["description"]
